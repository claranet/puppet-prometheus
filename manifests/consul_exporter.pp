...
class prometheus::consul_exporter (
  Boolean $consul_health_summary = true,
  String $consul_server          = 'localhost:8500',
  String $download_extension     = 'tar.gz',
  String $download_url_base      = 'https://github.com/prometheus/consul_exporter/releases',
  Array $extra_groups,
  String $group                  = 'consul-exporter',
  String $log_level              = 'info',
  String $package_ensure         = 'latest',
  String $package_name           = 'consul_exporter',
  String $user                   = 'consul-exporter',
  String $version                = '0.3.0',
  String $web_listen_address     = ':9107',
  String $web_telemetry_path     = '/metrics',

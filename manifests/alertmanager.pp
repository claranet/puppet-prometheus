...
class prometheus::alertmanager (
  Stdlib::Absolutepath $config_dir  = '/etc/alertmanager',
  Stdlib::Absolutepath $config_file = '/etc/alertmanager/alertmanager.yaml',
  String $download_extension        = 'tar.gz',
  Variant[Stdlib::HTTPUrl, Stdlib::HTTPSUrl] $download_url_base = 'https://github.com/prometheus/alertmanager/releases',
  Array $extra_groups,
  Hash $global                       = { 'smtp_smarthost' =>'localhost:25', 'smtp_from'=>'alertmanager@localhost' },
  String $group                      = 'alertmanager',
  Array $inhibit_rules               = [ { 'source_match' => { 'severity'=> 'critical' },'target_match'=> { 'severity'=>'warning'},'equal'=>['alertname','cluster','service']}],
  String $package_ensure             = 'latest',
  String $package_name               = 'alertmanager',
  Array $receivers                   = [ { 'name' => 'Admin', 'email_configs'=> [ { 'to'=> 'root@localhost' }] }],
  Hash $route                        = { 'group_by' =>  [ 'alertname', 'cluster', 'service' ], 'group_wait'=> '30s', 'group_interval'=> '5m', 'repeat_interval'=> '3h', 'receiver'=> 'Admin' },
  Stdlib::Absolutepath $storage_path ='/var/lib/alertmanager',
  Array $templates                   = [ '/etc/alertmanager/*.tmpl' ],

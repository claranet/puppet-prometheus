...
class prometheus (
  ...
  Variant[Stdlib::HTTPUrl, Stdlib::HTTPSUrl] $download_url_base = 'https://github.com/prometheus/prometheus/releases',
  ...
  Array $rule_files,
  Array $scrape_configs = [ { 'job_name'=> 'prometheus', 'scrape_interval'=> '10s', 'scrape_timeout'=> '10s', 'static_configs'=> [ { 'targets'=> [ 'localhost:9090' ], 'labels'=> { 'alias'=> 'Prometheus'} } ] } ],
